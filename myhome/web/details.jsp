      ...
      <table width="750" height="60" cellpadding="0" cellspacing="0" border="0">
        <tr>
          ...
          <td width="70%" valign="top">
             ...
             <div id="cart">
                 <a href="javascript:selflog_show(<%=item.getId()%>)"><img src="images/buy_now.png"></a><a href="javascript:selflog_show(<%=item.getId()%>)"><img src="images/in_cart.png"></a>
          ...
          <td width="30%" bgcolor="#EEE" align="center">
             ...
             <!-- 循环开始 -->
             <%
                List<Items> itemlist = itemDao.getViewList(list);
